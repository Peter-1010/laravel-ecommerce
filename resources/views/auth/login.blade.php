...
@section('content')
    ...
    <div class="container no-index">
        <div class="row">
                ...
                <div id="main">
                    <div class="page-header">
                        <h1 class="page-title hidden-xs-up">
                            {{__('site/auth.login to you account')}}
                        </h1>
                    </div>
            ...
            <button class="btn" type="button" data-action="show-password" data-text-show="Show" data-text-hide="{{__('site/auth.hide')}}">
              {{__('site/auth.show')}}
            </button>
          </span>
                                            </div>
                                        ...
                                        <div class="col-md-10 offset-md-2">
                                            <div class="forgot-password">
                                                <a href="password-recovery.html" rel="nofollow">
                                                    {{__('site/auth.forget your password?')}}
                                                </a>
                                            </div>
                                        </div>
                                    </div>
