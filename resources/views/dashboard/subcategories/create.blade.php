                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                for="parent_id">{{__('admin/categories.choose category')}}</label>
                                                            <select id="parent_id"
                                                                    class="select2 form-control"
                                                                    name="parent_id">
                                                                <optgroup
                                                                    label="{{__('admin/categories.please choose category')}}">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label
                                                                    for="name"> {{__('admin/categories.name')}}</label>
                                                ...
                                                <div class="form-actions">
                                                    <button type="submit" class="btn btn-primary">
                                                        <i class="la la-check-square-o"></i> {{__('admin/categories.create button')}}
                                                    </button>
