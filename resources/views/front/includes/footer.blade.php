<footer class="footer footer-three">
    <div class="inner-footer">
        <div class="container">
            <div class="row">
                <div class="nov-row footer-top direction_position" data-nov-full-width="true"><div class="nov-row-wrap row"><div class="nov-modules col-lg-12 col-md-12 "><div class="block nov-wrap"><div class="title_block">SIGN UP TO NEWSLETTER</div><div class="block_newsletter">
            ...
            <button class="btn btn-secondary effect-btn" name="submitNewsletter" type="submit">
                <span>subscribe</span>
                            ...
                            </div></div></div></div><div class="nov_row-full-width clearfix w-100"></div><div class="nov-row footer-center direction_position" data-nov-full-width="true"><div class="nov-row-wrap row"><div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 align-items-center justify-content-md-start justify-content-sm-center d-flex pb-xs-max-20 flex-center">
                    <span>
                        {{__('admin/index.copyright')}} &copy; {{__('admin/index.year')}} <a class="text-bold-800 grey darken-2" href="https://www.linkedin.com/in/peter-anwer-425660269/"
                                                                                             target="_blank">{{__('admin/index.peter')}} </a>, {{__('admin/index.footer')}}</span>
          </span>
                </div>
