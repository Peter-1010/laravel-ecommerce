    ...
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="contentsticky_verticalmenu verticalmenu-main col-lg-3 col-md-1 d-flex"
                ...
                <div class="toggle-nav d-flex align-items-center justify-content-start act">
                    <span class="btnov-lines"></span>
                    <span>{{__('site/home.shop by categories')}}</span>
                </div>
                                                        ...
                                                        <ul>
                                                            @foreach($category -> children as $child)
                                                                ...
                                                                <li class="item  parent">
                                                                    ...
                                                                    @isset($child -> childrens )
                                                                        <span class="show-sub fa-active-sub"></span>
                                                                        <div class="dropdown-menu">
                                                                            <ul>
                                                                                @foreach($child -> childrens  as $_children)
                                                                                    <li class="item ">
                                ...
                                <form method="get"
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="search_query_top"
                                               ...
                                               name="search_query" value="" placeholder="{{__('site/home.search')}}">

                                        <div class="input-group-btn nov_category_tree hidden-sm-down">
                                            <button type="button" class="btn dropdown-toggle" data-toggle="dropdown"
                                                    aria-haspopup="true" value="" aria-expanded="false">
                                                {{__('site/home.categories')}}
                                            </button>
